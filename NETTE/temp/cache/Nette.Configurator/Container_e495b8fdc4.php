<?php
// source: C:\wamp64\www\ZT4\NETTE\app/config/config.neon 
// source: C:\wamp64\www\ZT4\NETTE\app/config/config.local.neon 

class Container_e495b8fdc4 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\SuchanekPresenter' => [1 => ['application.7']],
		...
		'services' => [
			...
			'application.7' => 'App\Presenters\SuchanekPresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\wamp64\www\ZT4\NETTE\app',
			'wwwDir' => 'C:\wamp64\www\ZT4\NETTE\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\wamp64\www\ZT4\NETTE\app/../temp',
		];
	}
	...
	public function createServiceApplication__7(): App\Presenters\SuchanekPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\wamp64\www\ZT4\NETTE\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp64\www\ZT4\NETTE\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp64\www\ZT4\NETTE\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_e495b8fdc4 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\wamp64\www\ZT4\NETTE\app/../temp/cache/latte');
